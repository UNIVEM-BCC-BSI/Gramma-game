...
def main(window, LARGURA, ALTURA):
    """Função principal do cenário futurista."""
    ...
    # Diálogos e quiz
    dialogos = [
        "Sábio das Palavras: Bem-vindo(a) a NeoLumen, no ano 3000! Carros voadores, robôs inteligentes, e você... está prestes \na fazer história. Use o futuro com “will” para imaginar e planejar o que vai acontecer.",
        "Dica\nUse will e o going to para decisões, promessas e previsões.",
        "[Sujeito] + am/is/are + going to + verbo principal (forma base)",
        "Exemplo:",
        "Robots will help humans.",
    ...
    quiz = [
        {
            "pergunta": "1 - Complete a frase: She ___ become a famous inventor.",
            "alternativas": [
                "A) will",
                "B) will be",
                "C) will to"
        ...
        {
            "pergunta": "2 -People ___ live on Mars one day.",
            "alternativas": [
                "A) shall ",
                "B) will ",
                "C) will are"
        ...
        },
        {
            ...
            "alternativas": [
                "A) I'm going study English tomorrow.",
                "B) I'm going to study English tomorrow.",
                "C) I'm going to studying English tomorrow"
            ],
            "resposta_correta": "B"
        }
    ]
    ...
    inicial = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/CENARIO - CIDADE FUTURISTA.png")), (1280, 720))
    sprite_size = (170, 250)
    SPRITES = {
    ...
    boss = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/BOSS - FUTURISTA.png")), (450, 350))
    ...
    proxima_tela = None
    loop = True
    pos_mouse = (0,0) #move a inicialização para fora do loop
    while loop:
        ...
        if player.rect.colliderect(pygame.Rect(260, 550, 150, 150)):
            ...
            window.blit(fonte.render("Aperte E para conversar com ele", True, BRANCO), (299, 535))

        window.blit(boss, (850, 380))
        window.blit(fonte.render("Aperte X para conversar com ele", True, BRANCO), (950, 365))
        ...
        for event in pygame.event.get():
            ...
            #move a lógica de detecção para dentro do loop de eventos
    ...
    if game_over:
        ...
        proxima_tela = "sala_de_aula_fim"  # Garanta que isso esteja correto
    else:
        proxima_tela = "sair"
