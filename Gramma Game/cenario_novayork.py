...
def main(window, largura, altura):
    """Função principal do cenário de Nova York."""
    ...
    # Define os diálogos
    dialogos = [
        "Sábio das Palavras: Bem-vindo(a) à cidade que nunca dorme! Você acaba de chegar em Nova York, um lugar cheio de luzes, \narranha-céus e pessoas apressadas. Aqui, usamos o presente simples para falar de rotinas, fatos e hábitos. ",
        "Dica\nUse o verbo sem 's' para I / You / We / They\nAdicione 's' para He / She / It",
        "Exemplo:",
    ...
    quiz = [
        {
            "pergunta": "1 - Complete a frase:  People in New York usually ___ fast.",
            "alternativas": [
                "A) walk",
                "B) walks",
                "C) walking"
        ...
        {
            "pergunta": "2 -He ___ the subway to work every day.",
            "alternativas": [
                "A) take ",
                "B) takes",
                "C) taking"
    ...
    # Carrega as imagens
    inicial = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/CENARIO - NOVA YORK.png")), (largura, altura))
    sprite_size = (170, 250)
    sprites = {
    ...
    boss = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/BOSS - NOVA YORK.png")), (450, 350))
