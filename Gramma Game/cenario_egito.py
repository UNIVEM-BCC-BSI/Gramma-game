...
def main(window, LARGURA, ALTURA):
    """Função principal do cenário do Egito Antigo."""
    # Fontes
    ...
    # Diálogos e quiz (apenas textos adaptados para Egito)
    dialogos = [
        "Sábio das Palavras: Agora, estamos no Egito Antigo, explorando as terras do Nilo e desvendando os segredos das \npirâmides.",
        "Aqui, você precisa dominar o uso de 'was' e 'were' no passado.",
        "Use “was” ou “were” como passado de “is” e “are”.",
        "Exemplo:",
        "The T-Rex was very big.",
        "The pyramids were incredible structures.",
    ]

    quiz = [
        {
            "pergunta": "1 - Complete com a forma correta do Simple past",
            "alternativas": [
                "A) They was built in Giza.",
                "B) They were built in Giza",
                "C) They is build in Giza"
            ],
            "resposta_correta": "B"
        },
        {
            "pergunta": "2 -The pyramids ___ incredible structures of ancient Egypt.",
            "alternativas": [
                "A) Was ",
                "B) Were",
                "C) Are"
        ...
        {
            "pergunta": "3 - Complete com a forma correta do Simple past Ancient Egyptians ___ hieroglyphs on temple walls.",
            "alternativas": [
                "A) Write",
                "B) Wrote",
                "C) Writing"
    ...
    # Carregamento de imagens (adaptado para Egito)
    inicial = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/CENARIO - EGITO.jpg")), (1280, 720))
    sprite_size = (170, 250)
    SPRITES = {
    ...
    boss = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/BOSS - EGITO.png")), (450, 350))
    ...
    def renderizar_texto_multilinha(texto, fonte, cor, x, y):
        ...
        # Exibe "Aperte E" se o diálogo for pequeno (até 3 linhas)
        if len(linhas) <= 6:
