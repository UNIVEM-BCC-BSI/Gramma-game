...
def main(window, LARGURA, ALTURA):
    """Função principal do cenário do Apocalipse."""
    ...
    # Diálogos e quiz
    dialogos = [
        "Sábio das Palavras: A terra está em ruínas… o céu ficou escuro… mas ainda há esperança! No mundo pós-apocalíptico, \nprecisamos prever o que acontecerá — e para isso, usamos o tempo futuro com “will”.",
        "Dica\nwill + verbo base = futuro.",
        "Exemplo:",
        "I will survive.",
    ...
    quiz = [
        {
            "pergunta": "1 - Complete a frase: The survivors ___ rebuild the city.",
            "alternativas": [
                "A) will",
                "B) will be",
                "C) will to"
        ...
        {
            "pergunta": "2 - We ___ find food soon .",
            "alternativas": [
                "A) will ",
                "B) will found",
                "C) will finding"
    ...
    inicial = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/CENARIO - APOCALIPSE.png")), (1280, 720))
    sprite_size = (170, 250)
    SPRITES = {
    ...
    boss = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/BOSS - APOCALIPSE.png")), (450, 350))
    ...
    if game_over:
        ...
        proxima_tela = "cenario_futurista"
    else:
        proxima_tela = "sair"
