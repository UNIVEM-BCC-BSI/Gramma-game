...
def main(window, largura, altura):
    """Função principal do cenário do Japão."""
    ...
    # Define os diálogos
    dialogos = [
        "Sábio das Palavras: Agora, estamos no Japão — terra de templos, tecnologia e tradições. Aqui, usamos o presente simples \npara falar de rotinas, fatos e hábitos.",
        "Dica\nUse “do” para perguntas com I, you, we, they.\nUse “does” para he, she, it.",
        "Exemplo:",
        "Do you eat sushi?.",
    ...
    quiz = [
        {
            "pergunta": "1 - Qual dessas perguntas está correta?",
            "alternativas": [
                "A) Do she like sushi?",
                "B) Does she like sushi?",
                "C) Does she likes sushi?"
            ],
            "resposta_correta": "B"
        },
        {
            "pergunta": "2 -Japanese students ___ uniforms at school.",
            "alternativas": [
                "A) wear ",
                "B) wears",
                "C) wearing"
        ...
        {
            "pergunta": "3 -  He ___ tea every morning",
            "alternativas": [
                "A) drink",
                "B) drinks",
                "C) drinking"
    ...
    # Carrega as imagens
    inicial = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/CENARIO - JAPÃO.png")), (largura, altura))
    sprite_size = (170, 270)
    sprites = {
    ...
    npc = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/NPC.png")), (190, 170))
    boss = pygame.transform.scale(pygame.image.load(resource_path("CENARIOS E PERSONAGENS/BOSS - TOKYO.png")), (470, 350))
